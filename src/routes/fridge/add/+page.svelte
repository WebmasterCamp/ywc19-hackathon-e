  ...
  <div class="my-2">
    ...
    <div class="mx-4 overflow-scroll">
      ...
      <div class="relative">
        ...
        >
          <Icon class="text-black dark:text-white" icon="ic:baseline-search" />
        </div>
        <input
          type="search"
          id="search"
...
<Drawer placement='bottom' width='w-full' transitionType="fly" transitionParams={transitionParamsBottom} bind:hidden={hidden8} id='sidebar8' class="rounded-t-2xl">
